...
public class LevelsProvider
{
    ...
    private void createLevel01()
    {
        String lvl01Desc = "The year is 9001.\n" +
                ...
                "Shoot: Space";
        Level level01 = new Level(lvl01Desc, new Image("backgrounds/lvl01bg.png"));
        levels.add(level01);
    ...
    private void createLevel02()
    {
        String lvl02Desc = "Well done! The Sol system is now fully under Norwegian control.\n" +
                ...
                "Good luck pilot!";
        Level level02 = new Level(lvl02Desc, new Image("backgrounds/lvl02bg.png"));
        levels.add(level02);
    ...
    private void createLevel03()
    {
        String lvl03Desc = "Congratulations! The Alpha Centauri system is now ours!\n" +
                ...
                "Good flying!";
        Level level03 = new Level(lvl03Desc, new Image("backgrounds/lvl03bg.png"));
        levels.add(level03);
    ...
    private void createLevel04()
    {
        String lvl04Desc = "Well done! You have captured Tau Ceti. \n" +
                ...
                "Good luck pilot!";
        Level level04 = new Level(lvl04Desc, new Image("backgrounds/lvl04bg.png"));
        levels.add(level04);
    ...
    private void createLevel05()
    {
        String lvl05Desc = "Good job on securing the Rigel system! We can now move on to the Serious, er, Sirius System.\n" +
                ...
                "Go get'em pilot!";
        Level level05 = new Level(lvl05Desc, new Image("backgrounds/lvl05bg.png"));
        levels.add(level05);
    ...
    private void createLevel06()
    {
        String lvl06Desc = "Siriusly well done! You obviously are a very Sirius pilot.\n" +
                ...
                "Good luck!";
        Level level06 = new Level(lvl06Desc, new Image("backgrounds/lvl06bg.png"));
        levels.add(level06);
    ...
    private void createLevel07()
    {
        ...
        Level level07 = new Level(lvl07Desc, new Image("backgrounds/lvl07bg.png"));
        levels.add(level07);
    ...
    private void createLevel08()
    {
        ...
        Level level08 = new Level(lvl08Desc, new Image("backgrounds/lvl07bg.png"));
        levels.add(level08);
